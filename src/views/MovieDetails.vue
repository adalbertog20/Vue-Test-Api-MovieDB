...
<template>
  <div
    ...
    :style="{ backgroundImage: `url(${IMG_URL}${movieDetails.backdrop_path})` }"
  >
    ...
    <div class="hero-content">
      <div class="hero-content flex-col lg:flex-row">
        ...
        <div>
            ...
            <dialog id="my_modal_2" class="modal">
              <div class="modal-box">
                ...
                <form method="dialog">
                  <button
                    @click="sendRating"
                    class="btn btn-outline b btn-ghost w-full mt-4"
                  >
                    Rate
                  </button>
                </form>
          ...
          <div
            :class="'mt-20 radial-progress ' + color"
            :style="'--size:8rem; --value:' + Math.floor(movieVote)"
          >
